...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %> 
	<div class="container">
		<form:form action="/towel/store" method="post" class="form-group" modelAttribute="towelModel">
			<div class="col-10">
				...
				<div class="form-group mt-3">
					<label for="name"><i
						class="zmdi zmdi-grid"></i></label>
						<form:input path="img" type="file" placeholder="Hình ảnh" cssClass="form-control" />
				</div>
				<div class="form-group mt-3">
